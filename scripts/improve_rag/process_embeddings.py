...
class DocumentEmbeddingUpdater:
    ...
    def update_document_embeddings(self, batch_size: int = 50):
        ...
        try:
            ...
            if total_chunks == 0:
                logging.info("No chunks need embeddings")
                return
            ...
            for i in range(0, total_chunks, batch_size):
                ...
                try:
                    ...
                    embedding_data = [
                        (chunk_id, embedding, result['provider'], result['tokens_used'] // len(batch))
            ...
            logging.info(f"Completed embedding generation")
...
def main():
    print("Starting document content embedding update...")
    updater = DocumentEmbeddingUpdater()
    updater.update_document_embeddings()
